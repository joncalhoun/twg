...
func (us *UserStore) Find(id int) (*User, error) {
	...
	case nil:
		return &user, nil
	default:
		return nil, errors.Wrap(err, "builder: error querying for user by id")
	}
}
...
func (us *UserStore) Create(user *User) error {
	...
	if err != nil {
		return errors.Wrap(err, "builder: error creating new user")
	}
	return nil
}
...
func (us *UserStore) Delete(id int) error {
	...
	if err != nil {
		return errors.Wrap(err, "builder: error deleting user")
	}
	return nil
}
